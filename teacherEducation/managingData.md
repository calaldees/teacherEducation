...
* National School data?
    ...
    * [What is RAISEonline data – and why should it be publicly available?](http://helpmeinvestigate.com/education/2011/12/what-is-raiseonline-data-and-why-should-it-be-publicly-available/) 2011
        * There’s a vast store of information about our schools, but access is limited. 
    * Broken [Analysing school performance: NGA (National Governance Association)](https://www.governor.support/wp-content/uploads/2018/08/ASP-guidance_final-2018.pdf) 2018
...
* 2024 [DfE: No Progress 8 replacement for next two years](https://www.tes.com/magazine/news/secondary/dfe-no-progress-8-replacement-for-two-years)
...
* Other: Best 3 subjects from (vocational, lower-english, Art, DT, Drama, PE)
    * BTEC's have a mapping - merit = 6 (I think)
...
def gen_random_grades():
    return {
        ...
        for subject in chain(
            SUBJECTS['core'],
            random.sample(sorted(SUBJECTS['ebacc']), random.randint(3,4)),
            random.sample(sorted(SUBJECTS['other']), random.randint(2,5)),
        )
    }
