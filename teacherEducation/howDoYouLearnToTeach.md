...
* from [Education Workshop: Using PRIMM to teach Programming with Andy Colley](https://www.youtube.com/live/H0t2eBXazF0?t=590) at 10min
* @MrAColley
...
* repl.it `.draw` file
    * Collaborative tool! Whiteboard editor. It can export SVG


### Make
From scratch? Parsons?
...
[tacit-knowledge]: tacit-knowledge.md "tacit-knowledge"
